 ...
 *
 */
public class BaseSidingMenuV4 extends HorizontalScrollView {
     ...
     * @param defStyle
     */
    public BaseSidingMenuV4(Context context, AttributeSet attrs, int defStyle) {
...
//		mMenuRightPadding = (int)TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics());
    ...
    public BaseSidingMenuV4(Context context) {
        this(context, null, -1);
    }
     ...
     * @param attrs
     */
    public BaseSidingMenuV4(Context context, AttributeSet attrs) {
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        ViewHelper.setTranslationX(mMenu, mMenuWidth*scale*0.7f);//右边参数是初始隐藏大小
        //------------------菜单的效果-----------------
        ViewHelper.setScaleX(mMenu, leftScale);//缩放
        ViewHelper.setScaleY(mMenu, leftScale);
        ViewHelper.setAlpha(mMenu, leftAlpha);//透明度
